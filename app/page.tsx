    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-900 after:via-[#0141ff] after:blur-2xl after:content-[''] dark:before:bg-gradient-radial dark:before:from-white dark:before:to-transparent dark:after:from-[#0141ff] dark:after:via-[#0141ff] dark:after:bg-gradient-conic motion-reduce:before:transition-none motion-reduce:after:transition-none lg:static lg:before:bg-none  lg:after:bg-none">
        <a
          ...
          rel="noopener noreferrer"
        >
          <Image src="/next.svg" alt="Next.js Logo" className="dark:invert" width={180} height={37} priority />
        </a>
      </div>
